...
func init_shader():
	...
	$InputImage.texture = Texture2DRD.new()
	$OutputImage.texture = Texture2DRD.new()
	...
	$OutputImage.texture.texture_rd_rid = output_texture.texture
	$InputImage.texture.texure_rd_rid = input_texture.texture
